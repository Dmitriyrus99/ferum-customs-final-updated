...
class TestServiceRequest(FrappeTestCase):
    ...
    def _create_service_object(self, object_name: str, customer: str):
        if frappe.db.exists("service_object", object_name):
            return frappe.get_doc("service_object", object_name)
        so = frappe.get_doc({
            "doctype": "service_object"
        })
    ...
    def _assign_engineer_to_object(self, service_object_name: str, user_id: str):
        so_doc = frappe.get_doc("service_object", service_object_name)
